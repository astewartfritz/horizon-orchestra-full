...
from code_agent.telemetry.tracer import AgentTracer, TraceSpan
from code_agent.tracing.bridge import AgentTracerBridge
from code_agent.tracing.instrumentation import (
    TracingMiddleware,
    instrument_fastapi,
    instrument_httpx,
    trace_llm_call,
)
from code_agent.tracing.jaeger import (
    JaegerTracer,
    Span,
    SpanContext,
    configure_jaeger,
...
from code_agent.tracing.propagator import (
    TracePropagator,
    extract_traceparent,
    extract_tracestate,
    inject_traceparent,
...
class TestInstrumentation:
    ...
    def test_instrument_fastapi(self):
        ...
        from code_agent.tracing.instrumentation import instrument_fastapi as ifa
        assert callable(ifa)
