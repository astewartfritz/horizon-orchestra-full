...
class RedisStateGraph(StateGraph):
    ...
    def _deserialize_state(self, data: dict) -> TaskState:
        ...
        if plan_data:
            from code_agent.orchestrator.router.models import TaskIntent as TI, ModelLane, TaskStep, RouterPlan
            steps = []
...
from code_agent.orchestrator.router.models import TaskIntent, ModelLane
