"""OpenJarvis — Usage Tracking Middleware.
...
Usage::
    ...
    from openjarvis.billing.usage_tracker import UsageTracker
...
log = logging.getLogger("openjarvis.billing.usage_tracker")
...
TIER_LIMITS: dict[str, dict[str, Any]] = {
    "maker": {
        ...
        "max_swarm_agents": 0,
        "included_stt_seconds": 3600,
        "included_tts_seconds": 1800,
    ...
    "builder": {
        ...
        "max_swarm_agents": 5,
        "included_stt_seconds": 36000,
        "included_tts_seconds": 7200,
        "included_model_credit_cents": 1000,
    ...
    "pro": {
        ...
        "included_stt_seconds": 360000,
        "included_tts_seconds": 72000,
        "included_model_credit_cents": 5000,
    ...
    "enterprise": {
        ...
        "max_sessions_daily": 0,
        "max_swarm_agents": 0,
        "included_stt_seconds": 0,
        "included_tts_seconds": 0,
        "included_model_credit_cents": 20000,
...
_MODEL_COSTS: dict[str, tuple[float, float]] = {
    "kimi-k2.5":           (0.060, 0.250),
    "gemma-4-31b":         (0.030, 0.120),
...
class UsageBudget:
    ...
    tts_characters_remaining: float
...
class UsageTracker:
    ...
    async def track_tool_call(self, tool_name: str) -> tuple[bool, str]:
    ...
    async def track_swarm_spawn(self, agent_id: str, model: str) -> tuple[bool, str]:
    ...
    async def track_stt(self, duration_seconds: float, backend: str) -> tuple[bool, str]:
    ...
    async def track_tts(self, text_length: int, backend: str) -> tuple[bool, str]:
