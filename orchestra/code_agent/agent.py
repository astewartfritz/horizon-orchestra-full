...
from orchestra.code_agent.mdconfig.loader import MarkdownConfigLoader, AgentMdConventions
from orchestra.code_agent.guardrails.policy import Guardrails, CheckResult
from orchestra.code_agent.guardrails.nemoclaw import Nemoclaw, NemoclawConfig
from orchestra.code_agent.trace.collector import TraceCollector, EventType
...
from orchestra.code_agent.skills.v2 import SkillManagerV2, PersistentTrainer, CreditStore, SkillEvaluator, EvalStore
...
class Agent:
    def __init__(
        ...
        if config.enable_skills:
            ...
            from orchestra.code_agent.llm.base import LLM as _LLM
            from orchestra.code_agent.skills.v2 import SkillLibraryV2
        ...
        while iteration < self.config.max_iterations:
            ...
            if not response.tool_calls:
                ...
                if self.skill_manager_v2 and trajectory:
                    try:
                        from orchestra.code_agent.skills.v2 import TaskSpec, SkillV2, Trajectory as V2Traj
    ...
    async def _build_context(self, task: str) -> list[Message]:
        ...
        try:
            from orchestra.code_agent.agentic.navigator import ProjectNavigator
        ...
        try:
            from orchestra.code_agent.scaffold.context import LanguageDetector
        ...
        try:
            from orchestra.code_agent.context.retrieval import RetrievalPipeline
