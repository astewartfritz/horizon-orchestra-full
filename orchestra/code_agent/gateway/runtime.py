...
from orchestra.code_agent.channels.manager import ChannelManager, ChannelType, Message
...
class Gateway:
    ...
    def __init__(self, runtime: AgentRuntime | None = None):
        ...
        from orchestra.code_agent.gateway.webhooks import WebhookManager as _WM
        self.webhooks = _WM()
