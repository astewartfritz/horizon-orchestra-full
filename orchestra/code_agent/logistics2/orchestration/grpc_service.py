...
from orchestra.code_agent.logistics2.optimization.vrp_solver import VRPSolver, VRPConstraints, VRPStop
from orchestra.code_agent.logistics2.optimization.demand_forecast import DemandForecaster
from orchestra.code_agent.logistics2.dispatch.load_matcher import LoadMatcher, Load
...
class GRPCService:
    ...
    def optimize_tsp(self, request: dict[str, Any]) -> dict[str, Any]:
        from orchestra.code_agent.logistics2.optimization.tsp_solver import TSPSolver
        stops_data = request.get("stops", [])
