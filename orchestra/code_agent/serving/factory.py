...
from orchestra.code_agent.llm.base import LLMError
...
class ProviderFactory:
    ...
    def create(
        ...
        models: dict[str, list[str]] = {
            ...
            "opencode": ["opencode"],
            "claude_code": ["claude-code", "claude-code-4"],
            "codex": ["codex-mini-latest", "codex"],
        }
        ...
        if provider == "openai":
            ...
            return OpenCodeProvider(resolved_model, config)
        elif provider == "claude_code":
            return ClaudeCodeProvider(resolved_model, config)
        elif provider == "codex":
            return CodexProvider(resolved_model, config)
