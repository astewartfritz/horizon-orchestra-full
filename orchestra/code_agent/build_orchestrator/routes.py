...
from orchestra.code_agent.build_orchestrator.models import BuildType, PatchStatus, Platform
...
from orchestra.code_agent.build_orchestrator.brain import BuildBrain
...
def register_build_routes(app: Any, prefix: str = "/api/build") -> None:
    ...
    async def list_tasks(status: str | None = None,
        ...
        if status:
            try:
                from orchestra.code_agent.build_orchestrator.models import BuildStatus
    ...
    async def known_fixes():
        from orchestra.code_agent.build_orchestrator.brain import ERROR_FIXES
